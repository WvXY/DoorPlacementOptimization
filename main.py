...
p1 = Point(np.array([0.6, 0.2]))
p2 = Point(np.array([0.9, 0.6]))
tripath = nm.find_rough_path(p1, p2)[0]
vis.draw_tripath(tripath)

path = nm.funnel_algorithm(tripath, p1, p2)
vis.draw_point(p1, c="g", s=100)
vis.draw_point(p2, c="r", s=100)
